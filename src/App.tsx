...
import { ConnectionBanner, seedKnockoutTeams, teams, useTournamentState } from "./features/tournament";
  ...
  return (
    <div className="app-shell">
      ...
      <div className="layout">
        ...
        <main className="main-content"><Routes><Route path="/" element={<Overview matches={matches} />} /><Route path="/matches" element={<Matches matches={matches} />} /><Route path="/live" element={<Live matches={matches} />} /><Route path="/standings" element={<Standings matches={matches} />} /><Route path="/bracket" element={<Bracket matches={matches} />} /><Route path="/admin/setup" element={isAdmin ? <AdminSetup matches={matches} updateMatch={updateMatch} generateSchedule={generateSchedule} resetTournament={resetTournament} connection={connection} /> : <AdminGate onUnlock={handleAdminLogin} />} /><Route path="*" element={<Overview matches={matches} />} /></Routes></main>
      </div>
